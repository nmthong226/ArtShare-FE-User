...
const AIHeader = () => {
  ...
  return (
    <nav
      className={`z-50 flex relative justify-between items-center bg-white dark:bg-mountain-950 pr-2 lg:pr-4 border-b-1 border-b-mountain-100 dark:border-b-mountain-700 w-full h-16`}
    >
        ...
        {[
          ...
          return (
            <Link
              key={index}
              to={item.href}
              className={`${isActive ? "text-mountain-950" : "text-mountain-400"} flex justify-center items-center space-x-2 bg-white shadow py-1.5 rounded-xl w-40 text-mountain-600 hover:text-mountain-950 hover:scale-105 duration-200 ease-in-out hover:cursor-pointer transform`}
            >
