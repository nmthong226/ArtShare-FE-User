...
const Header: React.FC = () => {
  ...
  return (
    <nav
      className={`top-0 z-50 sticky flex justify-between items-center bg-white dark:bg-mountain-950 pr-2 lg:pr-4 border-b-1 border-b-mountain-100 dark:border-b-mountain-700 w-full h-16`}
    >
      <div className="flex items-center h-full">
        <div className="flex items-center space-x-1 lg:space-x-2 xl:space-x-4 px-4 h-full">
          ...
          <div
            className={`hidden top-1/2 left-1/2 absolute lg:flex items-center bg-mountain-50 dark:bg-mountain-1000 
