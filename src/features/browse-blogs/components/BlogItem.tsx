...
const BlogItem: React.FC<BlogItemProps> = ({
    ...
    return (
        <div key={blogId} className="flex space-x-4 bg-white border-mountain-200 hover:border-indigo-400 w-full">
            <div onClick={handleCardClick} className="flex bg-black w-64 h-48 overflow-hidden cursor-pointer shrink-0">
                <img
                    src={thumbnail}
            ...
            <div className="flex">
                <div className="flex flex-col justify-between space-y-2">
                    ...
                    <p className="font-medium hover:text-indigo-600 text-lg line-clamp-1 duration-300 ease-in-out cursor-pointer transform" onClick={handleCardClick}>{title}</p>
