...
const ProfileInfo: FC<ProfileInfoProps> = ({ name, username, bio, followings_count, followers_count, userId }) => {
  return (
    <div className="pt-3 px-4 pb-3">
      ...
      <ProfileStats following={followings_count || 0} followers={followers_count || 0} userId={userId} />
    </div>
  );
};
