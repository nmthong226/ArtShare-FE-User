  ...
  return (
    <div className="flex justify-center items-center gap-x-4 bg-white dark:bg-mountain-950 shadow-xl w-full h-full overflow-hidden">
      ...
      <div className="flex justify-center items-center w-full md:w-[40%]">
        <div
          className={`top-5 right-0 w-full md:w-[40%] absolute flex items-center space-x-2 px-10 md:px-1 lg:px-10 xl:px-20 ${
            showReturnToLogin ? "justify-between" : "justify-end"
          }`}
        >
          {showReturnToLogin && (
            <Link
              to="/login"
              className="flex items-center space-x-2 bg-mountain-100 dark:bg-mountain-800 p-2 px-4 rounded-2xl text-xs lg:text-sm"
            >
