    ...
    <div className="flex flex-col w-full h-full">
          ...
          <div className="flex items-center space-x-1 lg:space-x-2 xl:space-x-4 h-full">
            ...
            >
              <div className="hidden md:flex items-center space-x-1 lg:space-x-2 hover:bg-mountain-100 dark:hover:bg-mountain-1000 mt-1 p-2 rounded-lg dark:hover:text-mountain-50 hover:cursor-pointer">
                {location.pathname === "/gallery" ? <MdExplore className="w-6 h-6" /> : <MdOutlineExplore className="w-6 h-6" />}
      ...
      <div className="flex w-full">
        <aside className="sticky top-16 z-50 hidden xs:flex flex-col space-y-4 bg-white dark:bg-mountain-950 py-4 border-r-1 border-r-mountain-100 dark:border-r-mountain-700 w-16 h-full">
          <Link to="/gallery" className="group md:hidden flex flex-col justify-center items-center w-full h-16 hover:cursor-pointer">
            <div
              className={`flex justify-center items-center dark:group-hover:bg-mountain-800 group-hover:bg-mountain-100 dark:group-hover:text-mountain-50 group-hover:text-mountain-950 rounded-lg w-[80%] h-8 ${
                location.pathname === "/gallery" ? "bg-mountain-100 dark:bg-mountain-800" : "text-mountain-600"
              }`}
            >
              {location.pathname === "/gallery" ? <MdExplore className="w-6 h-6" /> : <MdOutlineExplore className="w-6 h-6" />}
            </div>
          ...
          <Link to="/blogs" className="group md:hidden flex flex-col justify-center items-center w-full h-16 hover:cursor-pointer">
            <div
              className={`flex justify-center items-center dark:group-hover:bg-mountain-800 group-hover:bg-mountain-100 dark:group-hover:text-mountain-50 group-hover:text-mountain-950 rounded-lg w-[80%] h-8 ${
                location.pathname === "/blogs" ? "bg-mountain-100 dark:bg-mountain-800" : "text-mountain-600"
              }`}
            >
              {location.pathname === "/blogs" ? <MdLibraryBooks className="w-6 h-6" /> : <MdOutlineLibraryBooks className="w-6 h-6" />}
            </div>
          ...
          <Link to="/shop" className="group md:hidden flex flex-col justify-center items-center w-full h-16 hover:cursor-pointer">
            <div
              className={`flex justify-center items-center dark:group-hover:bg-mountain-800 group-hover:bg-mountain-100 dark:group-hover:text-mountain-50 group-hover:text-mountain-950 rounded-lg w-[80%] h-8 ${
                location.pathname === "/shop" ? "bg-mountain-100 dark:bg-mountain-800" : "text-mountain-600"
              }`}
            >
              {location.pathname === "/shop" ? <RiShoppingBag4Fill className="w-6 h-6" /> : <RiShoppingBag4Line className="w-6 h-6" />}
            </div>
          ...
          <Link to="/search" className="group md:hidden flex flex-col justify-center items-center w-full h-16 hover:cursor-pointer">
            <div
              className={`flex justify-center items-center dark:group-hover:bg-mountain-800 dark:group-hover:text-mountain-50 group-hover:text-mountain-950 group-hover:bg-mountain-100 rounded-lg w-[80%] h-8 ${
                location.pathname === "/search" ? "bg-mountain-100 dark:bg-mountain-800" : "text-mountain-600"
              }`}
            >
          ...
          <Link to="/submit-media" className="group flex flex-col justify-center items-center w-full h-16 hover:cursor-pointer">
            <div
              className={`flex justify-center items-center dark:group-hover:bg-mountain-800 group-hover:bg-mountain-100 rounded-lg w-[80%] h-8 ${
                location.pathname === "/submit-media" ? "bg-mountain-100 dark:bg-mountain-800" : "text-mountain-600"
            ...
            <p
              className={`${
                location.pathname === "/submit-media" ? "dark:text-mountain-50" : "text-mountain-600 dark:text-mountain-500"
          ...
          <Link to="/create-art" className="group flex flex-col justify-center items-center space-y-2 w-full h-16">
            <div
              className={`flex justify-center items-center dark:group-hover:bg-mountain-800 group-hover:bg-mountain-100 dark:group-hover:text-mountain-50 group-hover:text-mountain-950 rounded-lg w-[80%] h-8 ${
                location.pathname === "/create-art" ? "bg-mountain-100 dark:bg-mountain-800" : "text-mountain-600"
              }`}
            >
            ...
            <p
              className={`${
                location.pathname === "/create-art" ? "dark:text-mountain-50" : "text-mountain-600 dark:text-mountain-500"
              } text-[10px] dark:group-hover:text-mountain-50`}
            >
              Create
            </p>
          ...
          <Link to="/portfolio" className="group flex flex-col justify-center items-center space-y-2 w-full h-16">
            <div
              className={`flex justify-center items-center dark:group-hover:bg-mountain-800 group-hover:bg-mountain-100 rounded-lg dark:group-hover:text-mountain-50 group-hover:text-mountain-950 w-[80%] h-8 ${
                location.pathname === "/portfolio" ? "bg-mountain-100 dark:bg-mountain-800" : "text-mountain-600"
              }`}
            >
            ...
            <p
              className={`${
                location.pathname === "/portfolio" ? "dark:text-mountain-50" : "text-mountain-600 dark:text-mountain-500"
              } text-[10px] dark:group-hover:text-mountain-50`}
            >
              Portfolio
            </p>
        ...
        <div className="w-[calc(100vw-4rem)] min-h-[calc(100vh-4rem)] bg-mountain-50">{children}</div>
      </div>
    </div>
  );
};
