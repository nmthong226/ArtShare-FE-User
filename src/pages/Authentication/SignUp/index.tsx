        ...
        <div className="flex-1 space-y-4 px-10 md:px-0 lg:px-20 py-8">
            ...
            <form className="space-y-4">
                ...
                <div className="flex justify-between items-center mt-4">
                    <span className="text-gray-600 text-xs xl:text-sm">Your password must be at least 8 characters, numbers and symbols.</span>
                </div>
            ...
            <div className="mt-6 text-left">
                <p className="text-gray-600 text-xs xl:text-sm">Already have an account?
