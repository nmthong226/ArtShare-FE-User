    ...
    return (
        <div className="flex-1 space-y-4 px-20 py-8">
            <div className="flex flex-col space-x-3">
                ...
                <p className="mt-2 font-bold text-gray-600 text-3xl">Create an ArtShare account</p>
                <p className="mt-4 text-gray-500">Join a thriving community to create, share and celebrate art.</p>
            </div>
            ...
            <form className="space-y-4">
                ...
                <div className="flex justify-between items-center mt-4">
                    <span className="text-gray-600 text-sm">Your password must be at least 8 characters, numbers and symbols.</span>
                </div>
                <Button type="submit" className="bg-gray-800 hover:bg-gray-700 py-3 rounded-lg focus:outline-none focus:ring-2 focus:ring-blue-500 w-full h-10 font-bold text-white">Signup with email</Button>
            </form>
            ...
            <div className="mt-4 text-gray-500 text-xs text-left">
                <p>By logging in to ArtShare, I confirm that I have read and agree to the ArtShare <a href="#" className="text-blue-600">Terms of Service</a>, <a href="#" className="text-blue-600">Privacy Policy</a>, and to receive emails and updates.</p>
            </div>
        </div>
    )
}
