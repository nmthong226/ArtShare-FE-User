    ...
    <div className="flex flex-col bg-white w-full h-screen">
      ...
      <div className="flex justify-between items-center bg-white px-4 md:px-8 lg:px-16 xl:px-24 py-5 w-full h-20">
        ...
        <div className='flex items-center space-x-4 md:space-x-8 font-semibold'>
          <div className='max-sm:hidden text-mountain-950 hover:text-indigo-600 hover:cursor-pointer'>Features</div>
          <div className='max-sm:hidden text-mountain-950 hover:text-indigo-600 hover:cursor-pointer'>Testimonials</div>
          <div className='max-sm:hidden text-mountain-950 hover:text-indigo-600 hover:cursor-pointer'>Pricing</div>
      ...
      <div className="sm:hidden -bottom-1 z-50 fixed flex justify-center items-center bg-white/70 py-5 w-full h-20">
        <div className='flex justify-between items-center md:space-x-8 bg-white px-4 border rounded-full w-[90%] h-12 font-semibold'>
          <div className='text-mountain-950 hover:text-indigo-600 hover:cursor-pointer'>Features</div>
          <div className='text-mountain-950 hover:text-indigo-600 hover:cursor-pointer'>Testimonials</div>
          <div className='text-mountain-950 hover:text-indigo-600 hover:cursor-pointer'>Pricing</div>
        </div>
      </div>
      {/* Hero Section */}
